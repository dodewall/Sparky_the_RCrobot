...
void debug_rf(void){
	...
	switch ( receive_buffer[11] ){
		case Single_Joy :
			 m_usb_tx_string("Single Joystick Driving\t"); break;
		case Double_Joy :
			m_usb_tx_string("Double Joystick Driving\t"); break;
		case Mario_Kart :
			m_usb_tx_string("Mario Kart RACING!\t"); break;
		case Tank_Mode:
			m_usb_tx_string("TANK MODE! \t"); break;
		default:
